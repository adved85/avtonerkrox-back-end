...
CREATE TABLE IF NOT EXISTS `carmodels` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1333;

--
-- Dumping data for table `model`
--

INSERT INTO `carmodels` (`id`, `make_id`, `code`, `title`) VALUES
...
(1315, 72, 'AGILA', 'Agila'),
(1316, 72, 'ANTARA', 'Antara'),
(1317, 72, 'ARENA', 'Arena'),
(1318, 72, 'ASCONA', 'Ascona'),
(1319, 72, 'ASTRA', 'Astra'),
(1320, 72, 'CALIBRA', 'Calibra'),
(1321, 72, 'COMBO', 'Combo'),
(1322, 72, 'CORSA', 'Corsa'),
(1323, 72, 'FRONTERA', 'Frontera'),
(1324, 72, 'INSIGNIA', 'Insignia'),
(1325, 72, 'MERIVA', 'Meriva'),
(1326, 72, 'OMEGA', 'Omega'),
(1327, 72, 'SINTRA', 'Sintra'),
(1328, 72, 'TIGRA', 'Tigra'),
(1329, 72, 'VECTRA', 'Vectra'),
(1330, 72, 'VECTRA B', 'Vectra B'),
(1331, 72, 'VITA', 'Vita'),
(1332, 72, 'ZAFIRA', 'Zafira');
